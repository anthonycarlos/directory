...
class TeachersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create teacher" do
    assert_difference('Teacher.count') do
      post teachers_url, params: { teacher: { grade: @teacher.grade, last: @teacher.last, title: @teacher.title } }
    end
  ...
  test "should update teacher" do
    patch teacher_url(@teacher), params: { teacher: { grade: @teacher.grade, last: @teacher.last, title: @teacher.title } }
